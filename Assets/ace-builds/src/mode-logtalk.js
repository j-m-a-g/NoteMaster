    ...
    this.$rules = {
      start: [
        ...
        },
        {
          token: "support.function.control.logtalk",
          regex:
            "\\b((?:uninstantiation|type|domain|existence|permission|representation|evaluation|resource|syntax)_error)(?=[(])"
        },
        {
          token: "support.function.control.logtalk",
        ...
        },
        {
          ...
          regex:
            "\\b(threaded(_(ca(?:ll|ncel)|once|ignore|exit|peek|wait|notify))?)(?=[(])"
        },
        {
          caseInsensitive: false,
