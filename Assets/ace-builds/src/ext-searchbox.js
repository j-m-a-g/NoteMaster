  ...
  var SearchBox = /** @class */ (function () {
      ...
      this.element = dom.buildDom([
        ...
        [
          ...
          [
            ...
            nls("search-box.find-all.text", "All")
          ]
        ],
        [
          "div",
          ...
          [
            ...
            nls("search-box.replace-next.text", "Replace")
          ],
          [
            "span",
            { action: "replaceAll", class: "ace_searchbtn" },
            nls("search-box.replace-all.text", "All")
          ]
        ],
        [
          "div",
    ...
    SearchBox.prototype.updateCounter = function () {
      ...
      this.searchCounter.textContent = nls(
        ...
        "$0 of $1",
        [before, all > MAX_COUNT ? MAX_COUNT + "+" : all]
      );
    };
    ...
    SearchBox.prototype.show = function (value, isReplace) {
      ...
      if (this.editor.$search.$options.regExp) value = lang.escapeRegExp(value);
