    ...
    this.add(
      ...
      function (state, action, editor, session, text) {
        if (text == ">") {
          ...
          if (
            this.voidElements &&
            this.voidElements.hasOwnProperty(element.toLowerCase())
          )
            return;
          return {
            text: ">" + "</" + element + ">",
      ...
      function (state, action, editor, session, text) {
        if (text == "\n") {
          ...
          if (is(token, "") && token.type.indexOf("tag-close") !== -1) {
            ...
            if (
              (this.voidElements && !this.voidElements[tag]) ||
              !this.voidElements
            ) {
...
define("ace/mode/behaviour/javascript", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
...
define("ace/mode/folding/javascript", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  (function () {
    ...
    this.getFoldWidgetRange = function (
      ...
      var range = this.getFoldWidgetRangeBase(
        session,
        foldStyle,
        row,
        forceMultiline
...
define("ace/mode/javascript", [
  ...
  var JavaScriptBehaviour =
    require("./behaviour/javascript").JavaScriptBehaviour;
    ...
    var tsRules = [
      {
        ...
        regex:
          "(function)(\\s+)([a-zA-Z0-9\$_\u00a1-\uffff][a-zA-Z0-9\d\$_\u00a1-\uffff]*)"
      },
      {
        token: "keyword",
        regex:
...
define("ace/mode/vue_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
          ...
          },
          {
            ...
            onMatch: function (value, currentState, stack, line) {
              ...
              if (parts.length > 1) {
                ...
                this.next = Array.isArray(currentData.state)
                  ? currentData.state[currentData.state.length - 1]
                  : currentData.state;
              }
              var data = new JavaScriptMode()
                .getTokenizer()
                .getLineTokens(text, "start");
              var tokens = data.tokens;
              if (currentData) {
                tokens.push.apply(
                  tokens,
                  __spreadArray([], __read(currentData.tokens), false)
                );
              }
              return tokens;
            }
